      ...
      >
        ...
        >
          <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded-sm flex items-center justify-center" style={{ backgroundColor: 'rgba(255,255,255,0.12)' }}>
          ...
          <div className="flex items-center space-x-2" style={{ color: '#a3a3a3' }}>
