...
import { User, ScrollText, ClipboardList, History, CreditCard, Ticket, FileText } from 'lucide-react'
import type { LucideIcon } from 'lucide-react'
import { useAdminLang } from '@/components/admin/AdminLangProvider'
import type { MsgKey } from '@/lib/admin-i18n'

export type ClientTab = 'overview' | 'contracts' | 'billing' | 'documents' | 'tickets' | 'notes' | 'history'

const PRIMARY: { id: ClientTab; icon: LucideIcon; labelKey: MsgKey }[] = [
  { id: 'overview', icon: User, labelKey: 'profile.tab.overview' },
  { id: 'contracts', icon: ScrollText, labelKey: 'profile.tab.contracts' },
