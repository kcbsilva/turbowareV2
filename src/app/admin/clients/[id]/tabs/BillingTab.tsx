...
import { CheckCircle, AlertTriangle, Clock, RefreshCw, Loader2, CreditCard } from 'lucide-react'
            ...
            {pendingInvs.map((inv) => (
              <div key={inv.id} className="px-4 py-3 flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-3 py-1.5 text-[10px] font-semibold rounded-md transition hover:opacity-90 disabled:opacity-50 shrink-0"
